...
<body>
    <form action="../controller/request_account.php" method="POST">
        ...
        <table id="student_list" cellspacing="0">
            ...
            <tr>
                <th></th>
                <th><img src="../image/add_button.jpg" id="add_row1" width="32px" onclick="add_row('student_list')"></th>
                <th></th>
                <th>Fullname</th>
                <th>Student ID</th>
                <th>Phone number</th>
            ...
            <tr id="row0">
                <td></td>
                <td><img src="../image/minus_button.png" id="minus_row1" width="32px" onclick="minus_row(this)"></td>
                <td >Student 1</td>
